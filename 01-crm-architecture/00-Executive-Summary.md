...
- [Business Discovery](Business_Discovery.md)
- [Current State Assessment](Current_State.md)
- [Future State Definition](Future_State.md)
- [CRM Architecture](CRM_Architecture.md)
- [Data Model](Data_Model.md)
- [CRM Object Model](CRM_Object_Model.md)
- [CRM Associations Model](CRM_Associations_Model.md)
...
- [CRM Data Governance](CRM_Data_Governance.md)
- [CRM Data Quality Framework](CRM_Data_Quality_Framework.md)
- [Naming Convention](Naming_Convention.md)
- [CRM Automation Architecture](CRM_Automation_Architecture.md)
- [CRM Reporting Architecture](CRM_Reporting_Architecture.md)
- [HubSpot Implementation Plan](HubSpot_Implementation_Plan.md)
- [Architecture Decisions Log](Architecture_Decisions.md)
- [Project Closure Report](LAB-01_Project_Closure_report.md)
