...
A identificação de uma Empresa utilizará uma combinação de propriedades, conforme definido no documento **02-CRM-Data-Governance.md**, não dependendo de um único identificador.
